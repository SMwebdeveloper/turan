...
const EditEvents = ({
  ...
  return (
    <form
      onSubmit={editEvent}
      className={`fixed top-1/2 left-1/2 min-h-[300px] transform -translate-x-1/2 -translate-y-1/2 w-[462px] py-[30px] px-[67px] z-50 flex flex-col justify-center gap-y-[35px] bg-yellowColor rounded-3xl transition-all duration-300 delay-75 ease-out ${
    ...
    >
      ...
      {eventLoading ? (
        <h3 className="text-2xl font-bold text-white text-center mx-auto">
          Yuklanmoqda
        </h3>
      ) : (
        <>
